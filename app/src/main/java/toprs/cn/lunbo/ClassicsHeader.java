...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    protected String KEY_LAST_UPDATE_TIME = "刷新时间";
...
//    }
    ...
    public toprs.cn.lunbo.ClassicsHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public toprs.cn.lunbo.ClassicsHeader setTimeFormat(DateFormat format) {
    ...
    public toprs.cn.lunbo.ClassicsHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
    ...
    public toprs.cn.lunbo.ClassicsHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
...
//            mRefreshKernel.requestRemeasureHeightForHeader();
    ...
    public toprs.cn.lunbo.ClassicsHeader setTextSizeTime(float size) {
...
//    }
    ...
    public toprs.cn.lunbo.ClassicsHeader setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
